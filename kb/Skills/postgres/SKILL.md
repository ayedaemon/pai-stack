...
- Preconditions: project under `/opt/data/Personal/...` with `docker-compose.yaml` postgres service, `*.sql`, `migrations/`, or ORM config (`prisma`, `drizzle`, `sqlalchemy`, `alembic`, `typeorm`, `sequelize`, `knex`)
