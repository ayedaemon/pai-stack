...
## Consequences
- Positive: ~3 GB RAM saved, no OAuth, simpler `docker compose ps`, one `hermes/config.yaml:54` to govern behavior, `Skills/_TEMPLATE/SKILL.md:13` steps simplified to direct draft.
