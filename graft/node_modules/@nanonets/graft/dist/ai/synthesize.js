...
function clean(nodes) {
    ...
    for (const n of nodes) {
        ...
        out.push({
            ...
            sources: Array.isArray(n.sources) ? n.sources.filter((s) => typeof s === "string") : [],
...
function nodesFromResponse(res) {
    ...
    if (!recovered)
        warnToolChoiceIgnored("synthesize", res.text?.trim() ? "unparsed" : "empty");
    return recovered;
}
