 ...
 */
export function firstRunNotice(home, env) {
    try {
        if (offReason(home, env) !== null)
            return null; // nothing to disclose if nothing can be sent
        if (readState(home)?.noticeShownAt)
            return null;
...
export function formatStatus(home, env) {
 ...
 */
export function formatDebug(home) {
