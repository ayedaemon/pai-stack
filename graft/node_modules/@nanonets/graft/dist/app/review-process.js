...
async function runInChild(job, deps, entry, timeoutMs) {
    ...
    try {
        return await new Promise((resolve, reject) => {
            ...
            child.on("exit", (code, signal) => settle(() => reject(new Error(`review process exited ${signal ? `on ${signal}` : `with code ${code}`} before reporting a result`))));
