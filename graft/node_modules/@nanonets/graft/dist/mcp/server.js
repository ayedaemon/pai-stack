 ...
 */
function advertised(root, dirOverride) {
    if (dirOverride !== undefined)
        return TOOLS;
    if (hasGraftIndex(root))
        return TOOLS;
 ...
 */
export function startMcpServer(root, dirOverride, version = '0') {
    ...
    rl.on('line', (line) => {
        ...
        switch (method) {
            ...
            case 'tools/call': {
                ...
                callTool(root, name, args, dirOverride).then((r) => {
