 ...
 */
export const GRAFT_MCP_TOOL_ALIASES = {
...
export const GRAFT_MCP_TOOL_NAMES = new Set([...GRAFT_MCP_TOOL_CANONICAL, ...Object.keys(GRAFT_MCP_TOOL_ALIASES)].map((n) => n.toLowerCase()));
